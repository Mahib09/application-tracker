...
export default function LoginPage() {
  return (
    <main className="relative flex min-h-screen items-center justify-center bg-background overflow-hidden">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -top-32 -left-32 size-150 rounded-full opacity-30"
        style={{
          background:
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <div className="rounded-2xl border border-border bg-card px-10 py-10 shadow-sm">
          ...
          <Link
            href="/"
            className="block text-base font-semibold tracking-tight text-foreground mb-8 hover:opacity-70 transition-opacity w-fit"
          >
            Paila
          </Link>
          ...
          {/* Legal */}
          <p className="mt-5 text-xs text-muted-foreground/60 text-center leading-relaxed">
